...
async function loadSession() {
    try {
        ...
        if (config.SESSION_ID.startsWith("Mercedes~")) {
            ...
            throw new Error("Invalid SESSION_ID format. Use 'Mercedes~' for base64 or 'MEGA~' for MEGA.nz");
        }
    } catch (error) {
...
╰──➤*`;
                ...
                try {
                    ...
                    await conn.sendMessage(jid, { text: upMessage });
        ...
        "120363339980514201@newsletter",
            ...
            const inviteCode = "GBz10zMKECuEKUlmfNsglx"; // Replace with your group invite code
            if (inviteCode) {
                try {
...
BotActivityFilter(conn);	
 ...
 /// READ STATUS       
  ...
  const udp = botNumber.split('@')[0];
    const immumd = ('254790375710', '254740007567');
